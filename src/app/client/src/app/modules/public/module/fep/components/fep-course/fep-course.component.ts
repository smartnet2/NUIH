...
import { ToasterService, ResourceService, INoResultMessage, ConfigService, ICaraouselData, UtilService, NavigationHelperService } from '../../../../../shared';

import { PageApiService, CoursesService, PlayerService, OrgDetailsService } from '../../../../../core/services';

import { ICourses, ISort } from '../../../../../core/interfaces';
...
import { PublicPlayerService } from '../../../..';


@Component({
  selector: 'app-fep-course',
  templateUrl: './fep-course.component.html',
  styleUrls: ['./fep-course.component.css']
})
export class FepCourseComponent implements OnInit {
